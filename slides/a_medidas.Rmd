...
output:
  xaringan::moon_reader:
    lib_dir: libs
    css: ["xaringan-themer.css", "default", "css/custom-css.css"]
    nature:
      ratio: "16:12"
...
1. Ver como os tipos de variáveis se refletem em uma base de dados
...
| $...$          | $...$          | $...$                    | $...$              | $...$                   | $...$                 |
| $x_k$| $n_k$          | $N_k=N_1+n_k$            | $f_k=\frac{n_k}{n}$| $F_k=F_{k-1}+f_k$       | $100f_k$              |
...
As variáveis numéricas podem ser descritas em duas dimensões: (1) as medidas de centro e (2) as medidas de dispersão. 

Nesta aula, vamos ver apenas as medidas de centro. Na aula seguinte, veremos as medidas de dispersão. 

As medidas de centro são:
1. Média
2. Mediana
3. Moda
...
.pull-left[$$\frac{1}{n}\sum_{i=1}^n|x_i-\bar x|$$]
...
.pull-left[$$\frac{1}{n}\sum_{i=1}^n(x_i-\bar x)^2$$]
