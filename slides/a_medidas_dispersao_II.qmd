...
A última medida de dispersão que temos é a amplitude inter-quartil (que vem do inglês _interquartile range_, de onde originou a sigla IQR). Para compreendermos o IQR, devemos compreender o que é um **quantil empírico**. 
