...
## Roteiro geral das aulas {.smaller}

Vamos começar vendo os tipos de variávies, que, .negrito-cor{basicamente}, podem ser dois: variáveis categóricas e variáveis numéricas. Depois, vamos ver as medidas desses tipos de variáveis, conforme a seguinte lista:
