...
$$dp(x) = \sqrt{\frac{1}{n}\sum_{i=1}^n(x_i-\bar x)^2}$$ \## Medidas de dispersão em torno da média

::: columns
::: column
#### Média dos desvios

$$\frac{1}{n}\sum_{i=1}^n(x_i-\bar x)$$ \#### Variância $$\frac{1}{n}\sum_{i=1}^n(x_i-\bar x)^2$$
:::
