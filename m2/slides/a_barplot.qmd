...
Em um eixo, ficam as categorias. No outro, fica alguma medida dessa categoria, seja a sua contagem ou sua proporção. 

O eixo que contém as categorias é o eixo que contém a variável que estamos descrevendo. O outro eixo é apenas uma característica dessa variável que estamos utilizando para descrever a variável de interesse. 

É possível haver uma segunda variável, além da categoria, que podemos representar de algumas formas distintas. Então dizemos que existem gráficos de barras univariados e os bivariados. 
...
## Como construir? - Bivariados (Agrupados)
...
## Como construir? - Bivariados (Em camadas)
...
**(d)** Gráficos agrupados permitem a comparação de todas as categorias dentro de um item.
:::
::::
...
![Fonte: from Data to Viz. **The Issue with Pie Chart**. Disponível em: https://www.data-to-viz.com/caveat/pie.html](img/pie-datatoviz.png)
...
![Fonte: from Data to Viz. **The Issue with Pie Chart**. Disponível em: https://www.data-to-viz.com/caveat/pie.html](img/bar-datatoviz.png)
