...
- O gráfico é construído a partir de estatísticas de resumo importantes. É preciso domínio sobre quantis empíricos para construir esse gráfico
- O gráfico pode vir apresentado tanto deitado, como de pé. É mais comum vê-lo na vertical. 
...
Começamos a fazer o boxplot pela caixa central. A caixa central é constituída dos três quartis, isto é, o quartil inferior (ou quantil de 25%), a mediana (ou quantil de 50%) e o quartil superior (ou quantil de 75%). 
...
Apesar dos bigodes poderem se estender até 3/2*IQR unidades depois dos quartis, eles não necessariamente vão parar aí. Eles param no maior valor encontrado nos dados que esteja dentro da região potencial do bigode. 
...
Uma vez delimitado o fim dos bigodes, podemos ir para o último elemento dos boxplots: os pontos. Os pontos são todas as observações que estão além do fim dos bigodes. 
