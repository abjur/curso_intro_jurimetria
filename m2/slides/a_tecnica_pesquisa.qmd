...
(1) ela é exequível com os conhecimentos de que você dispõe atualmente, uma vez que não exige conhecimentos técnicos de programação tão avançados;
...
É preciso usar algum software para analisar os dados. Na ABJ utiizamos muito o R. Mas é possível também utilizar outros softwares. A seguir, listamos alguns softwares comuns.
