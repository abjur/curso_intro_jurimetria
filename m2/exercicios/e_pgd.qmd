...
Se houver pedidos cumulativos, pelo art. 292, VI, o valor da ação será a soma de todos os pedidos.

Se há vários pedidos alternativos, pelo art. 292, VII, o valor da causa refletirá o pedido de maior valor.

Se houver pedidos subsidiários, pelo art. 292, VIII, o valor da ação refletirá o valor do pedido principal.
...
**a) Olhando a mediana, que 50% dos dados, qual dos dois órgãos aplicam multas mais altas? E penas de restrições?**
